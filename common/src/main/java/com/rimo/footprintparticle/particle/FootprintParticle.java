...
public class FootprintParticle extends SpriteBillboardParticle {
	...
	public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
		...
		vertexConsumer.vertex(pos[0].getX(), pos[0].getY(), pos[0].getZ()).texture(l, n).color(this.red, this.green, this.blue, this.alpha).light(o).next();
		vertexConsumer.vertex(pos[1].getX(), pos[1].getY(), pos[1].getZ()).texture(l, m).color(this.red, this.green, this.blue, this.alpha).light(o).next();
		vertexConsumer.vertex(pos[2].getX(), pos[2].getY(), pos[2].getZ()).texture(k, m).color(this.red, this.green, this.blue, this.alpha).light(o).next();
		vertexConsumer.vertex(pos[3].getX(), pos[3].getY(), pos[3].getZ()).texture(k, n).color(this.red, this.green, this.blue, this.alpha).light(o).next();
	}
